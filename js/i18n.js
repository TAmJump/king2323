...
(function () {
  ...
  const I18N_CONTENT = {
    ...
    'entry.label.receipt_id': {
      ja: 'Square 領収書 ID、または決済日時(JST)',
      en: 'Square Receipt ID or payment date/time (JST)',
      ko: 'Square 영수증 ID 또는 결제 일시 (JST)',
      es: 'ID de recibo de Square o fecha/hora del pago (JST)',
      hi: 'Square रसीद ID या भुगतान तिथि/समय (JST)',
      vi: 'ID hóa đơn Square hoặc ngày/giờ thanh toán (JST)',
      pt: 'ID do recibo do Square ou data/hora do pagamento (JST)',
      id: 'ID tanda terima Square atau tanggal/waktu pembayaran (JST)',
      th: 'รหัสใบเสร็จ Square หรือวันที่/เวลาชำระเงิน (JST)',
      fr: 'ID de reçu Square ou date/heure du paiement (JST)',
    },
