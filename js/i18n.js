/* ============================================================
   ...
   Version: v20260523m  (printed to console at load for debugging)
   ============================================================ */
...
(function () {
  ...
  console.log('%c[i18n] v20260523m loaded · cookie:', 'color:#b8862d;font-weight:bold',
  ...
  const I18N_CONTENT = {
    ...
    // --- LEGAL PAGE — Founding Bell Rules (rules.html) ---
    // Section headings only; long body paragraphs remain English+JP
    // (per CSS .jp / non-.jp hide rules) because they are legal contracts
    // and casual machine translation would be inappropriate.
    'rulespage.title': {
      ja: 'Founding Bell のルール',
      en: 'Founding Bell Rules',
      ko: 'Founding Bell 규칙',
      es: 'Reglas de la Founding Bell',
      hi: 'Founding Bell के नियम',
      vi: 'Quy tắc Founding Bell',
      pt: 'Regras da Founding Bell',
      id: 'Aturan Founding Bell',
      th: 'กฎ Founding Bell',
      fr: 'Règles de la Founding Bell',
    },
    'rulespage.h.schedule': {
      ja: '開催スケジュール',
      en: 'Schedule',
      ko: '일정',
      es: 'Calendario',
    ...
    'rulespage.h.what_is': {
      ja: 'Bell Entry とは何か、何でないか',
      en: 'What Bell Entry is — and is not',
      ko: 'Bell Entry란 무엇이며, 무엇이 아닌가',
      es: 'Qué es Bell Entry — y qué no es',
      hi: 'Bell Entry क्या है — और क्या नहीं है',
      vi: 'Bell Entry là gì — và không phải gì',
      pt: 'O que é Bell Entry — e o que não é',
      id: 'Apa itu Bell Entry — dan apa yang bukan',
      th: 'Bell Entry คืออะไร — และไม่ใช่อะไร',
      fr: 'Ce qu\'est Bell Entry — et ce qu\'il n\'est pas',
    },
    'rulespage.h.mission_entry': {
      ja: 'Mission Entry の提出',
      en: 'Mission Entry',
      ko: 'Mission Entry 제출',
      es: 'Envío de Mission Entry',
      hi: 'Mission Entry जमा करना',
      vi: 'Nộp Mission Entry',
      pt: 'Envio do Mission Entry',
      id: 'Pengajuan Mission Entry',
      th: 'การส่ง Mission Entry',
      fr: 'Soumission Mission Entry',
    },
    'rulespage.h.verification': {
      ja: '照合',
      en: 'Verification',
      ko: '대조 확인',
      es: 'Verificación',
    ...
    'rulespage.h.review': {
      ja: 'Mission Fund 審査',
      en: 'Mission Fund Review',
      ko: 'Mission Fund 심사',
      es: 'Revisión del Mission Fund',
      hi: 'Mission Fund समीक्षा',
      vi: 'Xét duyệt Mission Fund',
      pt: 'Análise do Mission Fund',
      id: 'Peninjauan Mission Fund',
      th: 'การพิจารณา Mission Fund',
      fr: 'Examen du Mission Fund',
    },
    'rulespage.h.opening': {
      ja: '初回サイクルの取り扱い',
      en: 'Opening Cycle Treatment',
      ko: '오프닝 사이클 처리',
      es: 'Tratamiento del Ciclo Inaugural',
      hi: 'प्रारंभिक चक्र का व्यवहार',
      vi: 'Cách xử lý Cycle khai mạc',
      pt: 'Tratamento do Ciclo de Abertura',
      id: 'Penanganan Cycle Pembuka',
      th: 'การจัดการ Cycle เปิดตัว',
      fr: 'Traitement du Cycle d\'ouverture',
    },
    'rulespage.h.cancellation': {
      ja: '中止',
      en: 'Cancellation',
      ko: '취소',
      es: 'Cancelación',
    ...
    'rulespage.h.geographic': {
      ...
      hi: 'भौगोलिक क्षेत्र',
      vi: 'Phạm vi địa lý',
      pt: 'Âmbito Geográfico',
      id: 'Cakupan Geografis',
      th: 'ขอบเขตทางภูมิศาสตร์',
      fr: 'Portée géographique',
    },

    // --- LEGAL PAGE — Risk / Important Notices (risk.html) ---
    // Section headings only; long body paragraphs remain English+JP.
    'riskpage.title': {
      ja: '重要事項',
    ...
    'riskpage.h.read_before': {
      ja: '決済前にお読みください',
      en: 'Read before you pay',
      ko: '결제 전에 읽어 주세요',
      es: 'Lea antes de pagar',
      hi: 'भुगतान से पहले पढ़ें',
      vi: 'Đọc trước khi thanh toán',
      pt: 'Leia antes de pagar',
      id: 'Baca sebelum membayar',
      th: 'อ่านก่อนชำระเงิน',
      fr: 'À lire avant de payer',
    },
    'riskpage.h.what_you_receive': {
      ja: '受け取るもの',
      en: 'What you receive',
      ko: '받게 되는 것',
      es: 'Lo que recibes',
      hi: 'आपको क्या मिलता है',
      vi: 'Những gì bạn nhận được',
      pt: 'O que você recebe',
      id: 'Yang Anda terima',
      th: 'สิ่งที่คุณจะได้รับ',
      fr: 'Ce que vous recevez',
    },
    'riskpage.h.founding_is_opening': {
      ja: 'Founding Bell は初回サイクルです',
      en: 'Founding Bell is the opening cycle',
      ko: 'Founding Bell은 오프닝 사이클입니다',
      es: 'Founding Bell es el ciclo inaugural',
      hi: 'Founding Bell प्रारंभिक चक्र है',
      vi: 'Founding Bell là Cycle khai mạc',
      pt: 'Founding Bell é o ciclo de abertura',
      id: 'Founding Bell adalah Cycle pembuka',
      th: 'Founding Bell คือ Cycle เปิดตัว',
      fr: 'Founding Bell est le Cycle d\'ouverture',
    },
    'riskpage.h.what_this_is_not': {
      ja: '本サービスでないもの',
      en: 'What this is not',
      ko: '본 서비스가 아닌 것',
      es: 'Lo que esto no es',
      hi: 'यह क्या नहीं है',
      vi: 'Dịch vụ này không phải là gì',
      pt: 'O que isto não é',
      id: 'Yang bukan ini',
      th: 'สิ่งที่บริการนี้ไม่ใช่',
      fr: 'Ce que ce service n\'est pas',
    },
    'riskpage.h.geo_limit': {
      ja: '対象地域の制限',
      en: 'Geographic limitation',
      ko: '대상 지역 제한',
      es: 'Limitación geográfica',
      hi: 'भौगोलिक सीमा',
      vi: 'Giới hạn địa lý',
      pt: 'Limitação geográfica',
      id: 'Pembatasan geografis',
      th: 'ข้อจำกัดทางภูมิศาสตร์',
      fr: 'Limitation géographique',
    },
    'riskpage.h.taxes': {
      ja: '税務',
      en: 'Taxes',
    ...
    'riskpage.h.do_not_if': {
      ja: '次の方は参加しないでください',
      en: 'Do not participate if',
      ko: '다음에 해당하시면 참가하지 마세요',
      es: 'No participe si',
      hi: 'भाग न लें यदि',
      vi: 'Không tham gia nếu',
      pt: 'Não participe se',
      id: 'Jangan ikut serta jika',
      th: 'อย่าเข้าร่วมหาก',
      fr: 'Ne participez pas si',
    },
    'riskpage.h.contact': {
      ja: 'お問い合わせ',
      en: 'Contact',
    ...
    // --- Corporate footer label (used on legal pages) ---
    'corp.label': {
      ja: 'タムジ株式会社 ↗',
      en: 'TAmJ Corporate ↗',
      ko: 'TAmJ 법인 ↗',
    ...
    // --- Homepage hero "tap to watch" overlay on the gorilla play frame ---
    'hero.tap_to_watch': {
      ja: 'タップで再生',
      en: 'TAP TO WATCH',
      ko: '탭하여 재생',
      es: 'TOCA PARA REPRODUCIR',
      hi: 'देखने के लिए टैप करें',
      vi: 'CHẠM ĐỂ XEM',
      pt: 'TOQUE PARA ASSISTIR',
      id: 'KETUK UNTUK MENONTON',
      th: 'แตะเพื่อเล่น',
      fr: 'APPUYEZ POUR REGARDER',
    },

    // --- Homepage "How it works (in 10 seconds)" 3-step explainer ---
    'quick.title': {
      ja: '10秒でわかる仕組み',
      en: 'How it works',
      ko: '10초로 보는 작동 방식',
    ...
    'quick.step1.h': {
      ja: '<span class="notranslate" translate="no">¥100</span>で参加。あなたの<span class="notranslate" translate="no">Mission</span>を書く。',
      en: 'Offer <span class="notranslate" translate="no">¥100</span>. Submit your <span class="notranslate" translate="no">Mission</span>.',
      ko: '<span class="notranslate" translate="no">¥100</span>으로 참가. 당신의 <span class="notranslate" translate="no">Mission</span>을 적어라.',
      es: 'Ofrece <span class="notranslate" translate="no">¥100</span>. Envía tu <span class="notranslate" translate="no">Mission</span>.',
      hi: '<span class="notranslate" translate="no">¥100</span> देकर भाग लें। अपना <span class="notranslate" translate="no">Mission</span> लिखें।',
      vi: 'Trả <span class="notranslate" translate="no">¥100</span>. Gửi <span class="notranslate" translate="no">Mission</span> của bạn.',
      pt: 'Ofereça <span class="notranslate" translate="no">¥100</span>. Envie sua <span class="notranslate" translate="no">Mission</span>.',
      id: 'Bayar <span class="notranslate" translate="no">¥100</span>. Ajukan <span class="notranslate" translate="no">Mission</span> Anda.',
      th: 'จ่าย <span class="notranslate" translate="no">¥100</span> ส่ง <span class="notranslate" translate="no">Mission</span> ของคุณ',
      fr: 'Offrez <span class="notranslate" translate="no">¥100</span>. Soumettez votre <span class="notranslate" translate="no">Mission</span>.',
    },
    'quick.step1.body': {
      ja: 'フォーム1枚。メアド + カード + 選ばれたら何をするか。それだけ。',
      en: 'One form. Email + card + what you\'d do if chosen. Done.',
      ko: '폼 하나. 이메일 + 카드 + 선택되면 무엇을 할지. 끝.',
      es: 'Un formulario. Correo + tarjeta + qué harías si te eligen. Listo.',
      hi: 'एक फॉर्म। ईमेल + कार्ड + चुने जाने पर क्या करेंगे। बस।',
      vi: 'Một biểu mẫu. Email + thẻ + bạn sẽ làm gì nếu được chọn. Xong.',
      pt: 'Um formulário. E-mail + cartão + o que você faria se escolhido. Pronto.',
      id: 'Satu formulir. Email + kartu + apa yang akan Anda lakukan jika terpilih. Selesai.',
      th: 'แบบฟอร์มเดียว อีเมล + บัตร + จะทำอะไรถ้าได้รับเลือก จบ',
      fr: 'Un formulaire. E-mail + carte + ce que vous feriez si choisi. Terminé.',
    },
    'quick.step2.h': {
      ja: '<span class="notranslate" translate="no">23:23 JST</span> に鐘が鳴る。',
      en: 'The <span class="notranslate" translate="no">Bell</span> rings at <span class="notranslate" translate="no">23:23 JST</span>.',
      ko: '<span class="notranslate" translate="no">23:23 JST</span>에 <span class="notranslate" translate="no">Bell</span>이 울린다.',
      es: 'La <span class="notranslate" translate="no">Bell</span> suena a las <span class="notranslate" translate="no">23:23 JST</span>.',
      hi: '<span class="notranslate" translate="no">23:23 JST</span> पर <span class="notranslate" translate="no">Bell</span> बजती है।',
      vi: '<span class="notranslate" translate="no">Bell</span> reo lúc <span class="notranslate" translate="no">23:23 JST</span>.',
      pt: 'A <span class="notranslate" translate="no">Bell</span> soa às <span class="notranslate" translate="no">23:23 JST</span>.',
      id: '<span class="notranslate" translate="no">Bell</span> berbunyi pukul <span class="notranslate" translate="no">23:23 JST</span>.',
      th: '<span class="notranslate" translate="no">Bell</span> ดังที่ <span class="notranslate" translate="no">23:23 JST</span>',
      fr: 'La <span class="notranslate" translate="no">Bell</span> sonne à <span class="notranslate" translate="no">23:23 JST</span>.',
    },
    'quick.step2.body': {
      ja: '<span class="notranslate" translate="no">Bitcoin</span> の <span class="notranslate" translate="no">hash</span> で 3 人が機械的に選ばれる。誰も介入できない。',
      en: '<span class="notranslate" translate="no">Bitcoin</span> block hash → <span class="notranslate" translate="no">SHA-256</span> → <span class="notranslate" translate="no">The Three</span> are picked. No human bias.',
      ko: '<span class="notranslate" translate="no">Bitcoin</span> 블록 해시 → <span class="notranslate" translate="no">SHA-256</span> → <span class="notranslate" translate="no">The Three</span>가 뽑힌다. 사람의 편견 없음.',
      es: 'Hash del bloque <span class="notranslate" translate="no">Bitcoin</span> → <span class="notranslate" translate="no">SHA-256</span> → se eligen <span class="notranslate" translate="no">The Three</span>. Sin sesgo humano.',
      hi: '<span class="notranslate" translate="no">Bitcoin</span> ब्लॉक हैश → <span class="notranslate" translate="no">SHA-256</span> → <span class="notranslate" translate="no">The Three</span> चुने जाते हैं। कोई मानवीय पूर्वाग्रह नहीं।',
      vi: 'Hash khối <span class="notranslate" translate="no">Bitcoin</span> → <span class="notranslate" translate="no">SHA-256</span> → <span class="notranslate" translate="no">The Three</span> được chọn. Không thiên vị con người.',
      pt: 'Hash do bloco <span class="notranslate" translate="no">Bitcoin</span> → <span class="notranslate" translate="no">SHA-256</span> → <span class="notranslate" translate="no">The Three</span> são escolhidos. Sem viés humano.',
      id: 'Hash blok <span class="notranslate" translate="no">Bitcoin</span> → <span class="notranslate" translate="no">SHA-256</span> → <span class="notranslate" translate="no">The Three</span> dipilih. Tanpa bias manusia.',
      th: 'แฮชบล็อก <span class="notranslate" translate="no">Bitcoin</span> → <span class="notranslate" translate="no">SHA-256</span> → คัดเลือก <span class="notranslate" translate="no">The Three</span> ไม่มีอคติของมนุษย์',
      fr: 'Hash de bloc <span class="notranslate" translate="no">Bitcoin</span> → <span class="notranslate" translate="no">SHA-256</span> → <span class="notranslate" translate="no">The Three</span> sont tirés. Sans biais humain.',
    },
    'quick.step3.h': {
      ja: '王の<span class="notranslate" translate="no">Mission</span>に資金が動く。',
      en: 'The <span class="notranslate" translate="no">King</span>\'s <span class="notranslate" translate="no">Mission</span> is funded.',
      ko: '<span class="notranslate" translate="no">King</span>의 <span class="notranslate" translate="no">Mission</span>에 자금이 움직인다.',
      es: 'La <span class="notranslate" translate="no">Mission</span> del <span class="notranslate" translate="no">King</span> recibe fondos.',
      hi: '<span class="notranslate" translate="no">King</span> के <span class="notranslate" translate="no">Mission</span> को धन मिलता है।',
      vi: '<span class="notranslate" translate="no">Mission</span> của <span class="notranslate" translate="no">King</span> được tài trợ.',
      pt: 'A <span class="notranslate" translate="no">Mission</span> do <span class="notranslate" translate="no">King</span> recebe fundos.',
      id: '<span class="notranslate" translate="no">Mission</span> sang <span class="notranslate" translate="no">King</span> didanai.',
      th: '<span class="notranslate" translate="no">Mission</span> ของ <span class="notranslate" translate="no">King</span> ได้รับเงินทุน',
      fr: 'La <span class="notranslate" translate="no">Mission</span> du <span class="notranslate" translate="no">King</span> est financée.',
    },
    'quick.step3.body': {
      ja: '資金が足りなければ次 <span class="notranslate" translate="no">Cycle</span> に繰越。王の権利は永久に残る。',
      en: 'If the pool isn\'t enough this <span class="notranslate" translate="no">Cycle</span>, it carries over. Your <span class="notranslate" translate="no">King</span> waits. Forever.',
      ko: '이번 <span class="notranslate" translate="no">Cycle</span>에 풀이 부족하면 다음으로 이월. 당신의 <span class="notranslate" translate="no">King</span>은 영원히 기다린다.',
      es: 'Si el fondo no alcanza en este <span class="notranslate" translate="no">Cycle</span>, se transfiere. Tu <span class="notranslate" translate="no">King</span> espera. Para siempre.',
      hi: 'इस <span class="notranslate" translate="no">Cycle</span> में पूल कम पड़े तो अगले में ले जाया जाता है। आपका <span class="notranslate" translate="no">King</span> हमेशा प्रतीक्षा करता है।',
      vi: 'Nếu quỹ không đủ trong <span class="notranslate" translate="no">Cycle</span> này, nó sẽ chuyển sang. <span class="notranslate" translate="no">King</span> của bạn chờ. Mãi mãi.',
      pt: 'Se o fundo não bastar neste <span class="notranslate" translate="no">Cycle</span>, é transferido. Seu <span class="notranslate" translate="no">King</span> espera. Para sempre.',
      id: 'Jika dana tidak cukup di <span class="notranslate" translate="no">Cycle</span> ini, dilanjutkan ke berikutnya. <span class="notranslate" translate="no">King</span> Anda menunggu. Selamanya.',
      th: 'ถ้ากองทุนไม่พอใน <span class="notranslate" translate="no">Cycle</span> นี้ จะถูกยกไป <span class="notranslate" translate="no">King</span> ของคุณรอ ตลอดไป',
      fr: 'Si la cagnotte ne suffit pas ce <span class="notranslate" translate="no">Cycle</span>, elle est reportée. Votre <span class="notranslate" translate="no">King</span> attend. Pour toujours.',
    },
    'quick.more': {
      ja: '→ もっと詳しく',
      en: '→ Full explanation',
      ko: '→ 자세히 보기',
      es: '→ Explicación completa',
      hi: '→ पूरी जानकारी',
      vi: '→ Giải thích đầy đủ',
      pt: '→ Explicação completa',
      id: '→ Penjelasan lengkap',
      th: '→ คำอธิบายฉบับเต็ม',
      fr: '→ Explication complète',
    },
    'quick.kings': {
      ja: '→ 王の殿堂',
      en: '→ <span class="notranslate" translate="no">Hall of Kings</span>',
      ko: '→ <span class="notranslate" translate="no">Hall of Kings</span>',
      es: '→ <span class="notranslate" translate="no">Hall of Kings</span>',
      hi: '→ <span class="notranslate" translate="no">Hall of Kings</span>',
      vi: '→ <span class="notranslate" translate="no">Hall of Kings</span>',
      pt: '→ <span class="notranslate" translate="no">Hall of Kings</span>',
      id: '→ <span class="notranslate" translate="no">Hall of Kings</span>',
      th: '→ <span class="notranslate" translate="no">Hall of Kings</span>',
      fr: '→ <span class="notranslate" translate="no">Hall of Kings</span>',
    },
    ...
    'entry.hint.payment_email': {
      ja: '領収書とログインリンクの送付先です',
      en: 'Where we send your receipt and login link',
      ko: '영수증과 로그인 링크를 보낼 주소입니다',
      es: 'Dirección donde enviaremos tu recibo y enlace de inicio de sesión',
      hi: 'रसीद और लॉगिन लिंक यहीं भेजा जाएगा',
      vi: 'Nơi chúng tôi gửi hóa đơn và liên kết đăng nhập',
      pt: 'Endereço para onde enviaremos seu recibo e link de acesso',
      id: 'Alamat untuk pengiriman tanda terima dan tautan masuk',
      th: 'ที่อยู่สำหรับส่งใบเสร็จและลิงก์เข้าสู่ระบบ',
      fr: 'Adresse où nous enverrons votre reçu et votre lien de connexion',
    },
    'entry.label.card': {
      ja: 'カード情報',
      en: 'Card information',
