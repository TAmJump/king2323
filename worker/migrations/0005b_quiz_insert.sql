-- KINGMAKER · 0005b · INSERT the English-first 60 quiz rows.
-- Run AFTER 0005a (which deletes the old rows).
-- Single INSERT statement so D1 Console can execute in one go.
